...
public class InGameMenuManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (PlayerPrefs.GetFloat("Look_Sensitivity") > 0)
        {
            lookSensitivitySlider.value = PlayerPrefs.GetFloat("Look_Sensitivity");
        }
    ...
    void OnMouseSensitivityChanged(float newValue)
    {
        ...
        PlayerPrefs.SetFloat("Look_Sensitivity", newValue);
    }
