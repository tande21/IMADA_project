...
/// <summary>
/// Custom Projectile class based on FPS/ProjectileStandard.
/// Add detection for HitDetectable objects.
/// </summary>
...
public class ProjectileCustom : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        DebugUtility.HandleErrorIfNullGetComponent<ProjectileBase, ProjectileCustom>(m_ProjectileBase, this, gameObject);
    ...
    void OnHit(Vector3 point, Vector3 normal, Collider collider)
    {
        ...
        else
        {
            ...
            HitDetectable hitDetectable = collider.GetComponent<HitDetectable>();
            if (hitDetectable)
            {
                hitDetectable.Hit(point);
            }
        }
